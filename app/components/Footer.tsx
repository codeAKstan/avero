    ...
    fetch("/api/settings")
      ...
      .then((data) => {
        if (data.success && data.settings) {
          if (data.settings.socialLinks) setSocialLinks(data.settings.socialLinks);
          if (data.settings.copyrightText) setCopyrightText(data.settings.copyrightText);
        }
      })
      .catch(() => {});
  }, []);
            ...
            <div className="flex flex-wrap items-center gap-3 mt-1">
              ...
              {socialLinks.whatsapp && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="w-9 h-9 rounded-full bg-slate-800 hover:bg-emerald-600 text-slate-400 hover:text-white flex items-center justify-center transition-all duration-200 shadow-sm"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {socialLinks.tiktok && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="TikTok"
                  className="w-9 h-9 rounded-full bg-slate-800 hover:bg-black text-slate-400 hover:text-white flex items-center justify-center transition-all duration-200 shadow-sm"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.28-2.6.77-5.23 2.72-6.93 1.46-1.28 3.4-1.97 5.34-1.92.02 1.34.01 2.68.01 4.02-.99-.07-2.01.19-2.86.72-1.07.65-1.74 1.85-1.74 3.09.02 1.25.7 2.43 1.77 3.07 1.07.64 2.45.69 3.56.14.99-.48 1.67-1.47 1.77-2.57.04-1.47.02-2.94.02-4.41V.02z"/>
                  </svg>
                </a>
              )}
              ...
              {socialLinks.telegram && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Telegram"
                  className="w-9 h-9 rounded-full bg-slate-800 hover:bg-sky-500 text-slate-400 hover:text-white flex items-center justify-center transition-all duration-200 shadow-sm"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm5.56 8.16l-2.03 9.56c-.15.68-.55.84-1.12.52l-3.1-2.28-1.49 1.44c-.17.17-.31.31-.63.31l.22-3.16 5.76-5.2c.25-.22-.05-.34-.39-.12l-7.12 4.48-3.07-.96c-.67-.21-.68-.67.14-.99l12.01-4.63c.56-.21 1.05.13.83.99z"/>
                  </svg>
                </a>
              )}
            </div>
