              ...
              <div className="bento-card sm:col-span-6 bg-white border border-slate-200/80 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-sm flex flex-col justify-between hover:border-[#2866e1]/40 transition-colors">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                    ...
                    <button className="py-1.5 px-1.5 sm:px-2 text-xs font-semibold rounded-lg bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100 transition-colors text-center">
                      High
                    </button>
                  </div>
                </div>
              ...
              <div className="bento-card sm:col-span-6 bg-[#2866e1] text-white rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-md flex flex-col justify-between">
                <div>
                  ...
                  <div className="bg-white/10 rounded-xl p-2.5 sm:p-3 text-xs leading-relaxed space-y-1.5 mb-3 border border-white/15">
                    ...
                    <div className="text-white/80 text-[10px] sm:text-[11px]">• High-sensitivity Troponin check</div>
                    <div className="text-white/80 text-[10px] sm:text-[11px]">• 12-lead ECG within 10 minutes</div>
                    <div className="text-white/80 text-[10px] sm:text-[11px]">• Aspirin 300mg + Antiplatelet</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-7 gap-1 text-center">
                  {[
                    ...
                    >
                      ...
                      <div className="text-[10px] sm:text-xs font-bold text-[#2866e1] mt-0.5">
                        {item.hrs}
                      </div>
                    </div>
                  ))}
